...
public class GameLoop extends Canvas implements Runnable {
    ...
    public GameLoop() {
        initPos1 = new Vector2D(250 , 0) ;
        robot1 = new Robot(initPos1) ;

        initPos2 = new Vector2D(550 , 0) ;
        ...
        levels = new LevelInfo[] {
                new LevelInfo(
                        "resources/levels/Mixed_Movement.wrl",
                        "Andromeda",
                        loadImage("resources/backgrounds/level1_bg/L0.png")
                ),
                new LevelInfo(
                        "resources/levels/Platform_Chaining.wrl",
                        "Night_City",
