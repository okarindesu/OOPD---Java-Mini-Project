...
public class Robot {
    ...
    public float getRoboWidth() { 
        return this.roboWidth ; 
    }
    public void setRoboWidth(float roboWidth) { 
        this.roboWidth = roboWidth ; 
    }
    public float getRoboHeight() { 
        return this.roboHeight ; 
    }
    public void setRoboHeight(float roboHeight) { 
